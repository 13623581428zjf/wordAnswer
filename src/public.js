...
//分享地址
var visiableBase = 'http://sports.qq.com/fansact/worldcupq.html';//worldcupqtest.html
//http://sports.qq.com/fansact/worldcupqtest.htm#/
var offOn =false;
function getAction(server, params, fun1, fun2){
	if(offOn){
		var api = 'http://matchweb.sports.qq.com/';//http://prematchweb.sports.qq.com
	}else{
		var api = '/api/';
	}
	$.ajax({
		...
		error: function(XMLHttpRequest, textStatus, errorThrown) {
			if($.isFunction(fun2)) {
				fun2(XMLHttpRequest,textStatus);
			}
		}
	});
}
